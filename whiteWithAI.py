...
#Once again, I never copied down his code or edited my own project watching him code.

#P.S there is a lot of unimportant code here that is neccessary for PvP but since the AI doesn't use
#mousePressed for example, all of the code checking for black pieces is unimportant
...
def drawComputer(app, canvas):
    if not app.whitesMove and not app.gameOver:
...
#Constantly checks if it is AI's move and if it is, then run the AI
def timerFired(app):
    if not app.whitesMove:
        ...
        if app.board[newRow][newCol] == 'p' and newRow == 7:
            app.board[newRow][newCol] = 'q'
        elif app.board[newRow][newCol] == 'P' and newRow == 0:
            app.board[newRow][newCol] = 'Q'
...
def canPlayerCastle(app, newRow, newCol):
    if app.whitesMove:
        ...
        elif (app.startRow == 7 and app.startCol == 4) and (newRow != 7 or newCol != 2):
        ...
        elif (app.startRow == 0 and app.startCol == 4) and (newRow != 0 or newCol != 2):
...
def isAICastling(app, row, col, newRow, newCol):
    if app.whitesMove:
        if (row == 7 and col == 4) and (newRow == 7 and newCol == 6) and app.whiteCanCastleRightSide:
            movePiece(app, 7, 7, 7, 5)
        elif (row == 7 and col == 4) and (newRow == 7 and newCol == 2) and app.whiteCanCastleLeftSide:
            movePiece(app, 7, 0, 7, 3)
    else:
        if (row == 0 and col == 4) and (newRow == 0 and newCol == 6) and app.blackCanCastleRightSide:
            movePiece(app, 0, 7, 0, 5)
        elif (row == 0 and col == 4) and (newRow == 0 and newCol == 2) and app.blackCanCastleLeftSide:
            movePiece(app, 0, 0, 0, 3)
